...
impl EditMode {
    ...
    pub fn as_str(self) -> &'static str {
        // The wire words are the serde `rename_all = "lowercase"` forms of each
        // variant (the index matches the discriminant order).
        const WORDS: [&str; 3] = ["replace", "insert", "delete"];
        WORDS[self as usize]
    }
}
...
#[cfg(test)]
#[path = "../../../tests/unit/tools/notebook_edit/apply.rs"]
mod tests;
