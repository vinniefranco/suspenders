//! The system prompt (CONTEXT.md: Voice): who the model is and how to work, one
//! fixed text Suspenders owns so the wording can be tuned per model in one
//! place. The compaction prompt lives with the rest of the Compaction framing in
//! [`super::compaction`].
