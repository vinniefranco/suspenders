...
//!
//! These are infrastructure, NOT Hooks: control-bearing and NOT fail-open
//! (ADR-0011). A `RunDeps` method that panics or returns an error fails the
//! Run honestly. Hooks remain the fail-open lifecycle-interception layer
//! (ADR-0066) - that isolation lives in `crate::hooks`, not here.
//!
